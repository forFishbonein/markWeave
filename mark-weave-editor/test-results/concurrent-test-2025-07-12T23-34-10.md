...
> jest --runInBand --verbose --testNamePattern=并发插入完整测试套件
  ...
  console.log
    B插入字符 "B" opId: 1752363250964@client
  ...
  console.log
    [0] "h" → opId: 1752363250947_0@client (时间戳: 1752363250947_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "e" → opId: 1752363250948_1@client (时间戳: 1752363250948_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "l" → opId: 1752363250948_2@client (时间戳: 1752363250948_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "l" → opId: 1752363250948_3@client (时间戳: 1752363250948_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "o" → opId: 1752363250948_4@client (时间戳: 1752363250948_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "A" → opId: 1752363250964@client (时间戳: 1752363250964)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "B" → opId: 1752363250964@client (时间戳: 1752363250964)
  ...
  console.log
    [0] "B" → opId: 1752363250979_21@client (时间戳: 1752363250979_21)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "B" → opId: 1752363250979_22@client (时间戳: 1752363250979_22)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "B" → opId: 1752363250979_23@client (时间戳: 1752363250979_23)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "A" → opId: 1752363250979_18@client (时间戳: 1752363250979_18)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "A" → opId: 1752363250979_19@client (时间戳: 1752363250979_19)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "A" → opId: 1752363250979_20@client (时间戳: 1752363250979_20)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "b" → opId: 1752363250978_14@client (时间戳: 1752363250978_14)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "a" → opId: 1752363250978_15@client (时间戳: 1752363250978_15)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [8] "s" → opId: 1752363250978_16@client (时间戳: 1752363250978_16)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [9] "e" → opId: 1752363250979_17@client (时间戳: 1752363250979_17)
  ...
  console.log
    [0] "s" → opId: 1752363250985_24@client (时间戳: 1752363250985_24)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "t" → opId: 1752363250985_25@client (时间戳: 1752363250985_25)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "a" → opId: 1752363250985_26@client (时间戳: 1752363250985_26)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "r" → opId: 1752363250985_27@client (时间戳: 1752363250985_27)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "t" → opId: 1752363250985_28@client (时间戳: 1752363250985_28)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "1" → opId: 1752363250985@client (时间戳: 1752363250985)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "2" → opId: 1752363250986@client (时间戳: 1752363250986)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "3" → opId: 1752363250986@client (时间戳: 1752363250986)
  ...
  console.log
    [0] "h" → opId: 1752363250993_37@client (时间戳: 1752363250993_37)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "e" → opId: 1752363250993_38@client (时间戳: 1752363250993_38)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "l" → opId: 1752363250993_39@client (时间戳: 1752363250993_39)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "l" → opId: 1752363250993_40@client (时间戳: 1752363250993_40)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "o" → opId: 1752363250993_41@client (时间戳: 1752363250993_41)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "o" → opId: 1752363250993_44@client (时间戳: 1752363250993_44)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "r" → opId: 1752363250993_45@client (时间戳: 1752363250993_45)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "l" → opId: 1752363250993_46@client (时间戳: 1752363250993_46)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [8] "d" → opId: 1752363250993_47@client (时间戳: 1752363250993_47)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [9] "X" → opId: 1752363250993@client (时间戳: 1752363250993)
  ...
  console.log
      中间时间: 1752363251002 (时差: 0ms)

      at Object.log (tests/crdt/concurrent.test.js:456:13)

  console.log
      结束时间: 1752363251002 (时差: 0ms)
  ...
  console.log
       字符 "T1" 时间戳: 1752363251002

      at log (tests/crdt/concurrent.test.js:33:15)
          at Array.forEach (<anonymous>)

  console.log
       字符 "T2" 时间戳: 1752363251002
  ...
  console.log
    最终文档: _9_2_9_0_8_2_8_0_7_2_7_0_6_2_6_0_5_2_5_0_4_2_4_0_3_2_3_0_2_2_2_0_1_2_1_0_0_2_0_0shred_document
...
FAIL tests/crdt/concurrent.test.js
  并发插入完整测试套件
    ...
    ✓ 中间位置并发插入 - 在指定字符后同时插入 (6 ms)
    ✓ 多字符并发插入 - 使用insertText (6 ms)
    ✓ 三客户端并发插入 - 复杂并发场景 (6 ms)
    ✓ 连续并发插入 - 模拟快速输入 (3 ms)
    ✓ 混合操作并发 - 插入+删除+格式化 (5 ms)
    ✓ 边界情况 - 空文档并发插入 (4 ms)
    ✓ 时间戳分析 - 验证排序规则 (3 ms)
    ✕ 极速并发插入 - 模拟高频输入场景 (1 ms)
    ✓ 网络分区模拟 - 部分同步场景 (5 ms)
    ✓ 大规模并发压力测试 - 10客户端同时操作 (15 ms)
...
**生成时间**: 2025/7/13 07:34:11
**源文件**: tests/crdt/concurrent.test.js
**输出文件**: /Users/aaron/Desktop/6200 毕业论文/markWeave/mark-weave-editor/test-results/concurrent-test-2025-07-12T23-34-10.md
