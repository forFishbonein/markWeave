...
> jest --runInBand --verbose --testNamePattern=并发插入完整测试套件
  ...
  console.log
    A插入字符 "A" opId: 1752414348594@client

      at Object.log (tests/crdt/concurrent.test.js:58:13)

  console.log
    B插入字符 "B" opId: 1752414348595@client
  ...
  console.log
    [0] "h" → opId: 1752414348581_0@client (时间戳: 1752414348581_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "e" → opId: 1752414348582_1@client (时间戳: 1752414348582_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "l" → opId: 1752414348582_2@client (时间戳: 1752414348582_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "l" → opId: 1752414348582_3@client (时间戳: 1752414348582_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "o" → opId: 1752414348582_4@client (时间戳: 1752414348582_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "B" → opId: 1752414348595@client (时间戳: 1752414348595)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "A" → opId: 1752414348594@client (时间戳: 1752414348594)
  ...
  console.log
      [0] "s" opId:1752414348602_0@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [1] "t" opId:1752414348602_1@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [2] "a" opId:1752414348602_2@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [3] "r" opId:1752414348602_3@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [4] "t" opId:1752414348602_4@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [5] "_" opId:1752414348602_5@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [6] "e" opId:1752414348602_6@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [7] "n" opId:1752414348602_7@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [8] "d" opId:1752414348602_8@client
  ...
  console.log
      [0] "s" opId:1752414348602_0@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [1] "t" opId:1752414348602_1@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [2] "a" opId:1752414348602_2@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [3] "r" opId:1752414348602_3@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [4] "t" opId:1752414348602_4@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [5] "_" opId:1752414348602_5@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [6] "e" opId:1752414348602_6@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [7] "n" opId:1752414348602_7@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [8] "d" opId:1752414348602_8@client deleted:false
  ...
  console.log
    下划线字符对象: <ref *2> YMap {
      _item: <ref *1> Item {
        id: ID { client: 790761676, clock: 20 },
        length: 1,
        origin: ID { client: 790761676, clock: 16 },
        left: Item {
          id: [ID],
          length: 1,
          origin: [ID],
      ...
      doc: Doc {
        ...
        clientID: 790761676,
        guid: '047da091-5a89-4238-a546-b8629205329f',
        collectionid: null,
  ...
  console.log
    下划线 "_" 的opId: 1752414348602_5@client
  ...
  console.log
    [0] "B" → opId: 1752414348618_0@client (时间戳: 1752414348618_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "B" → opId: 1752414348618_1@client (时间戳: 1752414348618_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "B" → opId: 1752414348618_2@client (时间戳: 1752414348618_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "A" → opId: 1752414348618_4@client (时间戳: 1752414348618_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "A" → opId: 1752414348618_5@client (时间戳: 1752414348618_5)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "A" → opId: 1752414348618_6@client (时间戳: 1752414348618_6)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "b" → opId: 1752414348617_0@client (时间戳: 1752414348617_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "a" → opId: 1752414348617_1@client (时间戳: 1752414348617_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [8] "s" → opId: 1752414348618_2@client (时间戳: 1752414348618_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [9] "e" → opId: 1752414348618_3@client (时间戳: 1752414348618_3)
  ...
  console.log
    [0] "s" → opId: 1752414348623_0@client (时间戳: 1752414348623_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "t" → opId: 1752414348623_1@client (时间戳: 1752414348623_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "a" → opId: 1752414348623_2@client (时间戳: 1752414348623_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "r" → opId: 1752414348623_3@client (时间戳: 1752414348623_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "t" → opId: 1752414348623_4@client (时间戳: 1752414348623_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "1" → opId: 1752414348624@client (时间戳: 1752414348624)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "3" → opId: 1752414348624@client (时间戳: 1752414348624)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "2" → opId: 1752414348624@client (时间戳: 1752414348624)
  ...
  console.log
    [0] "h" → opId: 1752414348636_0@client (时间戳: 1752414348636_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "e" → opId: 1752414348636_1@client (时间戳: 1752414348636_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "l" → opId: 1752414348636_2@client (时间戳: 1752414348636_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "l" → opId: 1752414348636_3@client (时间戳: 1752414348636_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "o" → opId: 1752414348636_4@client (时间戳: 1752414348636_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "o" → opId: 1752414348636_7@client (时间戳: 1752414348636_7)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "r" → opId: 1752414348636_8@client (时间戳: 1752414348636_8)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "l" → opId: 1752414348636_9@client (时间戳: 1752414348636_9)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [8] "d" → opId: 1752414348636_10@client (时间戳: 1752414348636_10)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [9] "X" → opId: 1752414348637@client (时间戳: 1752414348637)
  ...
  console.log
      中间时间: 1752414348645 (时差: 0ms)

      at Object.log (tests/crdt/concurrent.test.js:456:13)

  console.log
      结束时间: 1752414348645 (时差: 0ms)
  ...
  console.log
      A的opId: 1752414348645@client

      at Object.log (tests/crdt/concurrent.test.js:464:13)

  console.log
      B的opId: 1752414348645@client
  ...
  console.log
       字符 "T1" 时间戳: 1752414348645

      at log (tests/crdt/concurrent.test.js:33:15)
          at Array.forEach (<anonymous>)

  console.log
       字符 "T2" 时间戳: 1752414348645
  ...
  console.log
    🔍 baseChars: [
      { ch: 'b', opId: '1752414348648_0@client' },
      { ch: 'a', opId: '1752414348648_1@client' },
      { ch: 's', opId: '1752414348648_2@client' },
      { ch: 'e', opId: '1752414348648_3@client' }
    ]

      at Object.log (tests/crdt/concurrent.test.js:494:13)

  console.log
    🔍 lastCharId: 1752414348648_3@client
  ...
  console.log
    A: baseC4C3C2C1C0A4A3A2A1A0B4B3B2B1B0

      at Object.log (tests/crdt/concurrent.test.js:534:13)

  console.log
    B: baseC4C3C2C1C0A4A3A2A1A0B4B3B2B1B0

      at Object.log (tests/crdt/concurrent.test.js:535:13)

  console.log
    C: baseC4C3C2C1C0A4A3A2A1A0B4B3B2B1B0
  ...
  console.log
    最终文档: _9_2_9_0_5_2_5_0_8_2_8_0_1_21_0_7_2_7_0_4_2_4__2_2_2_0_6_2_6_0_3_2_3_0_0_2_0_0hrd_oumnt
  ...
  console.log
      状态: A="startCA", B="startCAB", C="startCA"
  ...
  console.log
      状态: A="startCAB", B="startCAB", C="startCAB"
...
PASS tests/crdt/concurrent.test.js
  并发插入完整测试套件
    ✓ 基础并发插入 - 两客户端开头同时插入 (21 ms)
    ✓ 中间位置并发插入 - 在指定字符后同时插入 (17 ms)
    ✓ 多字符并发插入 - 使用insertText (6 ms)
    ✓ 三客户端并发插入 - 复杂并发场景 (8 ms)
    ✓ 连续并发插入 - 模拟快速输入 (4 ms)
    ✓ 混合操作并发 - 插入+删除+格式化 (7 ms)
    ✓ 边界情况 - 空文档并发插入 (2 ms)
    ✓ 时间戳分析 - 验证排序规则 (4 ms)
    ✓ 极速并发插入 - 模拟高频输入场景 (7 ms)
    ✓ 网络分区模拟 - 部分同步场景 (6 ms)
    ✓ 大规模并发压力测试 - 10客户端同时操作 (23 ms)
...
**生成时间**: 2025/7/13 21:45:48
**源文件**: tests/crdt/concurrent.test.js
**输出文件**: /Users/aaron/Desktop/6200 毕业论文/markWeave/mark-weave-editor/test-results/concurrent-test-2025-07-13T13-45-47.md
