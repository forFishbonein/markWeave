...
> jest --runInBand --verbose --testNamePattern=并发插入完整测试套件
  ...
  console.log
    A插入字符 "A" opId: 1752403299705@client

      at Object.log (tests/crdt/concurrent.test.js:58:13)

  console.log
    B插入字符 "B" opId: 1752403299706@client
  ...
  console.log
    [0] "h" → opId: 1752403299691_0@client (时间戳: 1752403299691_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "e" → opId: 1752403299692_1@client (时间戳: 1752403299692_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "l" → opId: 1752403299692_2@client (时间戳: 1752403299692_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "l" → opId: 1752403299692_3@client (时间戳: 1752403299692_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "o" → opId: 1752403299692_4@client (时间戳: 1752403299692_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "A" → opId: 1752403299705@client (时间戳: 1752403299705)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "B" → opId: 1752403299706@client (时间戳: 1752403299706)
  ...
  console.log
      [0] "s" opId:1752403299716_0@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [1] "t" opId:1752403299716_1@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [2] "a" opId:1752403299716_2@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [3] "r" opId:1752403299716_3@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [4] "t" opId:1752403299716_4@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [5] "_" opId:1752403299716_5@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [6] "e" opId:1752403299716_6@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [7] "n" opId:1752403299716_7@client

      at log (tests/crdt/concurrent.test.js:98:17)
          at Array.forEach (<anonymous>)

  console.log
      [8] "d" opId:1752403299716_8@client
  ...
  console.log
      [0] "s" opId:1752403299716_0@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [1] "t" opId:1752403299716_1@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [2] "a" opId:1752403299716_2@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [3] "r" opId:1752403299716_3@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [4] "t" opId:1752403299716_4@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [5] "_" opId:1752403299716_5@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [6] "e" opId:1752403299716_6@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [7] "n" opId:1752403299716_7@client deleted:false

      at log (tests/crdt/concurrent.test.js:117:15)
          at Array.forEach (<anonymous>)

  console.log
      [8] "d" opId:1752403299716_8@client deleted:false
  ...
  console.log
    下划线字符对象: <ref *2> YMap {
      _item: <ref *1> Item {
        id: ID { client: 1617268132, clock: 20 },
        length: 1,
        origin: ID { client: 1617268132, clock: 16 },
        left: Item {
          id: [ID],
          length: 1,
          origin: [ID],
      ...
      doc: Doc {
        ...
        clientID: 1617268132,
        guid: 'a2b80f57-d2e3-4fea-882d-b2bbd552ae1b',
        collectionid: null,
  ...
  console.log
    下划线 "_" 的opId: 1752403299716_5@client
  ...
  console.log
    [0] "A" → opId: 1752403299757_4@client (时间戳: 1752403299757_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "A" → opId: 1752403299757_5@client (时间戳: 1752403299757_5)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "A" → opId: 1752403299757_6@client (时间戳: 1752403299757_6)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "B" → opId: 1752403299757_0@client (时间戳: 1752403299757_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "B" → opId: 1752403299757_1@client (时间戳: 1752403299757_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "B" → opId: 1752403299757_2@client (时间戳: 1752403299757_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "b" → opId: 1752403299756_0@client (时间戳: 1752403299756_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "a" → opId: 1752403299756_1@client (时间戳: 1752403299756_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [8] "s" → opId: 1752403299756_2@client (时间戳: 1752403299756_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [9] "e" → opId: 1752403299756_3@client (时间戳: 1752403299756_3)
  ...
  console.log
    [0] "s" → opId: 1752403299769_0@client (时间戳: 1752403299769_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "t" → opId: 1752403299769_1@client (时间戳: 1752403299769_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "a" → opId: 1752403299769_2@client (时间戳: 1752403299769_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "r" → opId: 1752403299769_3@client (时间戳: 1752403299769_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "t" → opId: 1752403299769_4@client (时间戳: 1752403299769_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "2" → opId: 1752403299770@client (时间戳: 1752403299770)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "3" → opId: 1752403299770@client (时间戳: 1752403299770)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "1" → opId: 1752403299770@client (时间戳: 1752403299770)
  ...
  console.log
    [0] "h" → opId: 1752403299779_0@client (时间戳: 1752403299779_0)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [1] "e" → opId: 1752403299779_1@client (时间戳: 1752403299779_1)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [2] "l" → opId: 1752403299779_2@client (时间戳: 1752403299779_2)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [3] "l" → opId: 1752403299779_3@client (时间戳: 1752403299779_3)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [4] "o" → opId: 1752403299779_4@client (时间戳: 1752403299779_4)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [5] "o" → opId: 1752403299779_7@client (时间戳: 1752403299779_7)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [6] "r" → opId: 1752403299779_8@client (时间戳: 1752403299779_8)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [7] "l" → opId: 1752403299779_9@client (时间戳: 1752403299779_9)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [8] "d" → opId: 1752403299779_10@client (时间戳: 1752403299779_10)

      at log (tests/crdt/concurrent.test.js:15:15)
          at Array.forEach (<anonymous>)

  console.log
    [9] "X" → opId: 1752403299779@client (时间戳: 1752403299779)
  ...
  console.log
      中间时间: 1752403299790 (时差: 0ms)

      at Object.log (tests/crdt/concurrent.test.js:456:13)

  console.log
      结束时间: 1752403299790 (时差: 0ms)
  ...
  console.log
      A的opId: 1752403299790@client

      at Object.log (tests/crdt/concurrent.test.js:464:13)

  console.log
      B的opId: 1752403299790@client
  ...
  console.log
       字符 "T1" 时间戳: 1752403299790

      at log (tests/crdt/concurrent.test.js:33:15)
          at Array.forEach (<anonymous>)

  console.log
       字符 "T2" 时间戳: 1752403299790
  ...
  console.log
    🔍 baseChars: [
      { ch: 'b', opId: '1752403299793_0@client' },
      { ch: 'a', opId: '1752403299793_1@client' },
      { ch: 's', opId: '1752403299793_2@client' },
      { ch: 'e', opId: '1752403299793_3@client' }
    ]

      at Object.log (tests/crdt/concurrent.test.js:494:13)

  console.log
    🔍 lastCharId: 1752403299793_3@client
  ...
  console.log
    最终文档: _4_24_0_2_2_2_0_8_2_8_0_0_2_0_0_6_2_6_0_1_2_1_0_9_2_9_0_3_2_3_0_7_2_7_0_5_2_5_0sedument
...
PASS tests/crdt/concurrent.test.js
  并发插入完整测试套件
    ...
    ✓ 中间位置并发插入 - 在指定字符后同时插入 (41 ms)
    ✓ 多字符并发插入 - 使用insertText (12 ms)
    ✓ 三客户端并发插入 - 复杂并发场景 (7 ms)
    ✓ 连续并发插入 - 模拟快速输入 (3 ms)
    ✓ 混合操作并发 - 插入+删除+格式化 (9 ms)
    ✓ 边界情况 - 空文档并发插入 (2 ms)
    ✓ 时间戳分析 - 验证排序规则 (4 ms)
    ✓ 极速并发插入 - 模拟高频输入场景 (4 ms)
    ✓ 网络分区模拟 - 部分同步场景 (9 ms)
    ✓ 大规模并发压力测试 - 10客户端同时操作 (26 ms)
    ✓ 乱序同步测试 - 模拟网络延迟和重排 (2 ms)
    ✓ 冲突解决一致性 - 相同时间戳处理 (1 ms)
    ✓ 网络丢包模拟 - 随机丢失更新 (4 ms)
    ✓ 网络延迟模拟 - 不同延迟下的同步 (4 ms)
    ✓ 网络重复传输模拟 - 处理重复消息 (4 ms)
    ✓ 网络带宽限制模拟 - 批量更新优化 (6 ms)

Test Suites: 7 skipped, 1 passed, 1 of 8 total
Tests:       27 skipped, 17 passed, 44 total
Snapshots:   0 total
Time:        0.736 s, estimated 2 s
...
**生成时间**: 2025/7/13 18:41:40
**源文件**: tests/crdt/concurrent.test.js
**输出文件**: /Users/aaron/Desktop/6200 毕业论文/markWeave/mark-weave-editor/test-results/concurrent-test-2025-07-13T10-41-38.md
